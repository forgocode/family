...
LDFLAGS="\
 -X 'github.com/forgocode/family/pkg/bininfo.GoVersion=$(GoVersion)'\
 -X 'github.com/forgocode/family/pkg/bininfo.SystemName=$(SystemName)'\
 -X 'github.com/forgocode/family/pkg/bininfo.CommitID=$(GitCommitID)'\
 -X 'github.com/forgocode/family/pkg/bininfo.BuildTime=$(BuildTime)'\
 -X 'github.com/forgocode/family/pkg/bininfo.Version=$(Version)'\
 -X 'github.com/forgocode/family/pkg/bininfo.GinLogMode=${GinLogMode}'\
"
